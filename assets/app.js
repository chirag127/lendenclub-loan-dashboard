/* LenDenClub Loan Analytics Dashboard — decision view: 50 curated charts (of 83 defined), Apache ECharts */
"use strict";
...
/* ============ Why — reasons behind the numbers (narrative section, zero charts) ============ */
SECTIONS.push({
  name: "Why? — the reasons behind every number",
  sub: "Plain-language explanations for the findings on this dashboard. Every figure below is read live from the same regenerated data the charts use. These are whole-book numbers (they ignore the filters above) — nothing here is new math, it explains what the charts show and, in one line each, which loans that means you should actually fund.",
  charts: [],
  why: true,
});
